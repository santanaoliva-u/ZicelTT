...
trap ctrl_c INT
function ctrl_c() {
    echo -e "\e[0;31m SALIENDO DE 𝒁𝑰𝑻𝑬𝑳𝑻𝑻\e[0m"
    sleep 2s
    limpiar
    exit 0
}
...
echo -e "\e[1;31m                      ────██████████████─────\e[0m"
echo -e "\e[1;31m                      ────▀▀◯▀▀▀▀▀▀▀▀◯▀─────\e[0m"
echo -e "\e[1;31m                          𝒁𝑰𝑻𝑬𝑳𝑻𝑻   𝑻𝑼 𝑯𝑨𝑪𝑲𝑰𝑵𝑮 𝑹𝑨𝑷𝑰𝑫𝑶    \e[0m"
echo -e "\e[1;31m                     --------------------------------------------------\e[0m"
...
echo
sleep 1s
echo -e "\e[1;34m   CREADOR DEL SCRIPT :\e[0m \e[1;31mFastmore Crak \e[0m"
sleep 1s
echo -e "\e[1;34m   PAGINA WEB :\e[0m \e[1;31mhttps://fastmorecrak.github.io/Home/index.html\e[0m"
sleep 1s
echo -e "\e[1;34m   GITHUB :\e[0m \e[1;31mhttps://github.com/FastmoreCrak/ZicelTT\e[0m"
sleep 1s
echo
while :
do 
...
sleep 2s 
limpiar
echo -e "\e[1;31m[*]𝘾𝙍𝙀𝘼𝙉𝘿𝙊 𝘼𝙋𝙇𝙄𝘾𝘼𝘾𝙄𝙊𝙉 𝘾𝙊𝙉 𝙀𝙓𝙋𝙇𝙊𝙄𝙏 ...\e[0m"
sleep 2s 
echo -e "\e[1;31m[*]𝙏𝙀𝙍𝙈𝙄𝙉𝘼𝘿𝙊 𝘿𝙀 𝙀𝙓𝙋𝙊𝙍𝙏𝘼𝙍..\e[0m"
